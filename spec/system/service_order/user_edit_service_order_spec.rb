...
describe "Usuário edita uma Ordem de Serviço" do
  ...
  it 'com sucesso' do
    ...
    service = ServiceOrder.create!(address:'rua carvalho mota, 125', dimensions: '10cm x 15cm x 20cm', weight: 2, recipient:'Maria José', status: 0,
      recipient_address: 'rua cruzeiro do sul, 714', sku:'iphone-12s', total_distance: 20, arrival_time:24, delivered_at: '2022-10-10', transport_type: transport_type, vehicle: vehicle)
    #act
    login_as(user)
    visit root_path
